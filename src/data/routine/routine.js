...
const UNAUTHORIZED_RESPONSE={data:UNAUTHORIZED_MESSAGE,status:UNAUTHORIZED};
const BAD_REQUEST_RESPONSE={data:BAD_REQUEST_MESSAGE,status:BAD_REQUEST};
const CONFLICT_RESPONSE={data:CONFLICT_MESSAGE,status:CONFLICT};
